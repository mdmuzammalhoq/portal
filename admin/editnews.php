...
<?php 
    $queryy = "SELECT * FROM tbl_news WHERE id='$id' ";
    $update = $db->select($queryy);
    if ($update) {
        while ($resultty = $update->fetch_assoc()) {
?>
                            <div class="form-group">

                                <div class="col-lg-12">
                                    <input class="form-control" name="title" type="text" value="<?php echo $resultty['title']; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <select name="title-color" class="form-control">
                                        ...
                                        <option <?php if ($resultty['subtitle_color'] == 'ED0010') { ?>
                                            selected = "selected"
                                        <?php } ?> value="ED0010">RED</option>
                                        <option <?php if ($resultty['subtitle_color'] == '006C6E') { ?>
                                            selected = "selected"
                                        <?php } ?> value="006C6E">GREEN</option>
                                        <option <?php if ($resultty['subtitle_color'] == 'fff') { ?>
                                            selected = "selected"
                                        <?php } ?> value="fff">WHITE</option>
                                        <option <?php if ($resultty['subtitle_color'] == '666969') { ?>
                                            selected = "selected"
                                        <?php } ?> value="666969">BLACK</option>
                                        <option <?php if ($resultty['subtitle_color'] == 'F6FF00') { ?>
                                            selected = "selected"
                                        <?php } ?> value="F6FF00">YELLOW</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    <input name="subtitle" class="form-control" type="text" value="<?php echo $resultty['subtitle']; ?>">
                                </div>
                            </div>
...
?>
                            ...
                            <div class="form-group">
                                <div class="col-lg-12">
                                    <select name="publish_status" class="form-control">
                                        ...
                                        <option <?php if ($resultty['publish_status'] == 'Publish Now') { ?>
                                            selected = "selected"
                                        <?php }?> value="Publish Now">Publish Now</option>
                                        <option <?php if ($resultty['publish_status'] == 'Publish Later') { ?>
                                            selected = "selected"
                                        <?php } ?> value="Publish Later">Publish Later</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input class="form-control" name="image" type="file" value="adm-pol/<?php echo $resultty['image']; ?>">
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        <div class="form-group" style="height: 314px;border: 2px solid #c7c5c5;overflow-y: scroll hidden;overflow-x: hidden; border-radius: 5px; background: #fff;">
...
?>  
    ...
    <div class="checkbox" style="margin-left: 20px;">
      <label>
            <input <?php if ($resultty['category'] == $result['cat_name']) { ?>
                checked = "checked"
            <?php } ?> type="checkbox" name="newscat[]" <?php if($result['cat_name'] == $cate){foreach($_POST['newscat'] as $categ){echo $categ; } } ?> value="<?php echo $result['cat_name']; ?>"><?php echo $result['cat_name']; ?>
      </label>
    </div>
<?php  } } ?>
                ...
                <div class="form-group">
                    <img src="<?php echo $resultty['image']; ?>" style="width: 80px; height: 35px; padding-left: 20px;" alt="">
                </div>
                <div class="form-group">

                    <div class="col-lg-12" style="margin-bottom: 20px;z-index: 1;">
                        <textarea name="body" class="form-control" value=""><?php echo $resultty['body']; ?></textarea>
                    </div>
